...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    #
    # Some classes (for example the standard library's socket class) define their
    # own send method which has nothing to do with Object#send. So if you want to
    # work with objects of any class, you need to use __send__ to be on the safe side.
    #
    # ref: http://stackoverflow.com/questions/4658269/ruby-send-vs-send
  end
